...
pub const input_log = @import("terminal/input_log.zig");
pub const command_tracker = @import("terminal/command_tracker.zig");
pub const shell_observer = @import("terminal/shell_observer.zig");
pub const key_encode = @import("terminal/key_encode.zig");
pub const view = @import("terminal/view.zig");
pub const buffer = @import("terminal/buffer.zig");
...
pub const automation = @import("terminal/automation.zig");
pub const automation_ws = @import("terminal/automation_ws.zig");
pub const automation_http = @import("terminal/automation_http.zig");
pub const automation_graphql = @import("terminal/automation_graphql.zig");
pub const automation_service = @import("terminal/automation_service.zig");
...
pub const InputLog = input_log;
pub const CommandTracker = command_tracker;
pub const ShellObserver = shell_observer;
...
pub const Automation = automation;
pub const AutomationWs = automation_ws;
pub const AutomationHttp = automation_http;
pub const AutomationGraphql = automation_graphql;
pub const AutomationService = automation_service;
...
test {
    ...
    _ = @import("terminal/input_log.zig");
    _ = @import("terminal/command_tracker.zig");
    _ = @import("terminal/shell_observer.zig");
    _ = @import("terminal/key_encode.zig");
    _ = @import("terminal/view.zig");
    _ = @import("terminal/buffer.zig");
    ...
    _ = @import("terminal/automation.zig");
    _ = @import("terminal/automation_ws.zig");
    _ = @import("terminal/automation_http.zig");
    _ = @import("terminal/automation_graphql.zig");
    _ = @import("terminal/automation_service.zig");
